...
function sending(phone,template){
    ...
    console.log(req.PhoneNumberSet,req.TemplateParamSet);
        ...
        client.SendSms(req, function (err, response) {
            ...
            // 请求正常返回，打印response对象
            console.log("success:",response.to_json_string());
        });
}
...
router.post("/",async function(req,res){
    ...
    let keyNO = [];
    keyNO.push(randomNum);
    keyNO.push("2");
    console.log(phoneNO,keyNO);
    sending(phoneNO,keyNO);
    res.send({msg:"发送成功",result:"true",key:"randomNum_key"})
})
